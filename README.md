...
LiveData Объекты данных, которые уведомляют представления об изменениях базовой базы данных.
...
![AAehyQC 1](https://user-images.githubusercontent.com/114995936/216959064-d7178f9a-ec8a-4ab2-94dd-4a16a43318ae.png)
